...
function _e($s){
  ...
  $fl = "../library/lang/$lang/$lang.json";
  if(file_exists($fl)){
...
function UploadImage($fupload_name = null, $folder = null, array $quality = NULL){
  ...
  $vdir_upload = "../../../content/upload/$folder/";
...
function resize($newWidth, $targetFile, $originalFile, $quality) {
    ...
    switch ($mime) {
            ...
            case 'image/jpeg':
                    $image_create_func = 'imagecreatefromjepg';
...
function root_uri($sring_result = true){
  ...
  $strpos = strpos($current_url, "admin26");
