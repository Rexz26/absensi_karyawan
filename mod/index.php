	        			...
	        			<nav class="navbar navbar-expand-md navbar-light">
	        				...
	        				<div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
	        					<ul class="navbar-nav nav ml-auto">
	        						<li class="nav-item"><a href="#home"><i aria-hidden="true" class="fa fa-home"></i> BERANDA</a></li>
	        				...
	        				<div class="row h-100 justify-content-center align-items-center">
	        					<div class="col-lg-5">
	        						<div class="hero-content text-center text-white">
	        							<p>
	        								<img src="<?php echo $site_url; ?>/content/logo/logotrans.png" class="img-fluid" width="150px">
	        							</p>
	        							<h4 class="text-white">Absensi Daring Dinas Penanaman Modal dan Pelayanan Perizinan Terpadu Satu Pintu </h4>
	        							<p>
	        					...
	        					<div class="col-lg-6">
	        						<img style="border-radius: 30px;" src="<?php echo $site_url; ?>/content/logo/fotokantor.jpg" class="img-fluid">
	        					</div>
	        				</div>
	        			</div>
	        		</div>
	        		...
	        		<div class="row">
	        			...
	        			<div class="col-lg-4 col-md-12">
	        				<div class="single-footer-widget pl-5">
	        					...
	        					<ul class="list">
	        						<li><a href="http://dpmpptsp.binjaikota.go.id/index.php" title="Tentang Kami" alt="Tentang Kami">Tentang Kami</a></li>
	        			...
	        			<div class="col-lg-4 col-md-12">
	        				<div class="single-footer-widget pl-5">
	        					...
	        					<ul class="list">
	        						<li><a href="http://dpmpptsp.binjaikota.go.id/index.php">Hubungi Kami</a></li>
	        						<li><a href="http://diskominfo.binjaikota.go.id/">Mitra & Jaringan</a></li>
	        					</ul>
	        				</div>
	        			</div>
	        			<div class="col-lg-12 col-md-12">
	        				<div class="copyright-area">
	        					Copyright ©2021 <a class="text-white" href="./"> Absensi Daring DPMPPTSP</a> by <a class="text-white" href="wa.me/6282176495033"> Chairul Azhar</a>.
	        				</div>
	        			</div>
	        		</div>
	        	</div>
