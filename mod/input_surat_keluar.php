...
?>
        ...
        <div id="appCapsule">
            <div class="section mt-2 mb-3">
                <a href="./surat_keluar" class="btn btn-danger mb-2"><ion-icon name="arrow-back-circle"></ion-icon>Kembali</a>
                <div class="card">
                    <div class="card-body">
                        <!-- Your form goes here -->
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control-file mb-1" id="file_surat" name="file_surat" accept="application/pdf">(Format: Nomor Surat_Surat Keluar_Nama Karyawan.pdf)</input>
                                    </div>
                                </div>
                            </div>
                        ...
                        if(isset($_POST['submit'])) {
                            ...
                            if(empty($_POST['nomor_surat']) || empty($_POST['tujuan']) || empty($_POST['tanggal_surat']) || empty($_POST['perihal']) || empty($_FILES['file_surat'])) {
                                ...
                                if(move_uploaded_file($_FILES["file_surat"]["tmp_name"], $target_file)) {
                                    ...
                                    $query = "INSERT INTO surat_keluar (nomor_surat, tujuan, tanggal_surat, perihal, file_surat) 
                                    VALUES ('$nomor_surat', '$tujuan', '$tanggal_surat', '$perihal', '$file_surat')";
