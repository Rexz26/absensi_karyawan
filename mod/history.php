  ...
  echo'<!-- App Capsule -->
    ...
    <div class="card-body">
        ...
        <div class="col-sm-4 col-md-4 justify-content-between">
           <button type="button" class="btn btn-primary mt-1 btn-sortir"><ion-icon name="checkmark-circle"></ion-icon>Tampilkan</button>
           <button type="button" class="btn btn-warning mt-1" data-toggle="modal" data-target="#modal-print"><ion-icon name="print"></ion-icon> Cetak</button>
           <button type="button" class="btn btn-success mt-1 btn-clear"><ion-icon name="trash"></ion-icon> Clear</button>
        </div>
