            ...
            <div class="wallet-card">
                ...
                <div class="wallet-footer text-center">
                    <div class="webcam-capture-body text-center">
                        ...
                        echo'
                        <button class="btn btn-success btn-lg btn-block" onClick="captureimage(0)"><ion-icon name="camera"></ion-icon>Absen Pulang</button>';}
                        else{
                        echo'
                        <button class="btn btn-success btn-lg btn-block" onClick="captureimage(0)"><ion-icon name="camera"></ion-icon>Absen Masuk</button>';
                        }
                        echo'
                        </div>
                    </div>
