  ...
  <div class="login-box">
    <div class="login-logo">
      <div style="background:#00B4FF;border-radius:30px;padding:10px 15px" class="section text-center">
        ...
        <a href="<?php echo $site_url; ?>"><img src="<?php echo $site_url; ?>/content/<?php echo $site_logo; ?>" height="50"></a>
      </div>
    </div>
    <!-- /.login-logo -->
...
?>
    ...
    <footer class="text-muted text-center">
      Absensi DPMPPTSP <a href="#" rel="dofollow" target="_blank">By</a> - <a href="#" rel="dofollow" target="_blank">Chairul Azhar</a><br/><div style="display: none;"><a class="credits" href="https://s-widodo.com" rel="nofollow" target="_blank"></a></div>
    </footer>
